...
class Shape{
	constructor(width = 375, height = 667) {
		...
		this.canvas.width = width % Config.shape.gap == 0 ? width : Math.floor(width/Config.shape.gap) * Config.shape.gap;
	...
	//写入想要渲染的字
	write({txt, size=50, fontFamily='Helvetica', x = this.canvas.width / 2, y = 100} = {}){
